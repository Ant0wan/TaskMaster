...
impl IniConfig {
    ...
    fn add_section(&mut self, section_name: String) {
        self.sections.insert(section_name, HashMap::new());
    }

    fn add_key_value(&mut self, section_name: String, key: String, value: String) {
        let section = self
            .sections
            .entry(section_name)
...
fn parse_ini_file(filename: &str) -> Result<IniConfig, std::io::Error> {
